          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-6 ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}>
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  I'm a motivated Software Engineering undergraduate with hands-on experience in AWS (EC2, S3, RDS, IAM),
                  Terraform, Docker, and CI/CD pipelines. I build scalable cloud infrastructure and develop cross-platform
                  mobile apps using Flutter with Firebase integration.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Strong problem-solving skills, Git discipline, and adaptability to new technologies. I take ownership of
                  projects end-to-end, with a focus on automation and efficiency.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                ...
                <div className="flex items-center space-x-3 group">
                  <div className="w-3 h-3 bg-accent rounded-full animate-pulse delay-200 group-hover:scale-125 transition-transform" />
                  <span className="text-foreground font-medium">{counters.projects}+ Projects Completed</span>
                </div>
                <div className="flex items-center space-x-3 group">
                  <div className="w-3 h-3 bg-primary rounded-full animate-pulse delay-400 group-hover:scale-125 transition-transform" />
              ...
              <div className="flex flex-wrap gap-4 pt-6">
                <a href="/lovable-uploads/Kani_Leenas_Cv_DevOps_Intern.pdf" download className="inline-block">
            ...
            <div className={`relative ${isVisible ? 'animate-scale-up delay-500' : 'opacity-0'}`}>
              <div className="bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl p-8 backdrop-blur-sm border border-border hover:border-primary/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-primary/10">
                <div className="text-center space-y-6">
                  ...
                  <div className="flex justify-center gap-4 pt-4">
                    {['🧑‍💻','📱','☁️','🌐','🧠','🎓','⚙️','🚀'].map((e, i) => (
                      <div key={i} className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center hover:bg-primary/30 transition-colors hover:scale-110 transform cursor-pointer">
              ...
              {/* Floating blobs */}
              <div className="absolute -top-4 -left-4 w-16 h-16 bg-primary/10 rounded-full animate-bounce delay-1000" />
              <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-accent/10 rounded-full animate-pulse delay-500" />
            </div>
          </div>
        </div>
      </div>
